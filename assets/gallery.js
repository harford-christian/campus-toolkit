  ...
  var TOOLS = {
    ...
    'campus-control': {
      ...
      body:
        ...
        '<p><b>Now:</b> every door locks and unlocks automatically on the bell schedule and <b>auto-adjusts for weather</b> (2-hour delays), calendar events, athletics, and church days. One-tap event overrides, a live &ldquo;who&rsquo;s open now&rdquo; leadership board, and an operations dashboard with success/failure analytics and auto-remediation — all layered on the existing hardware.</p>' +
